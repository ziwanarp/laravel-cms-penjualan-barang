...
<section id="basic-horizontal-layouts">
    <div class="row match-height" >
        <div class="col-md-7 col-12">
            <div class="card " style="background-image: linear-gradient(rgba(128,128,128,0.5), rgba(128,128,128,0.5)), url('{{ asset('assets/images/bglogin.jpg') }}'); background-size: cover; background-position: center;"
>
